...
{
  return new InstanceFactory<VtrizeInstance>();
}

void VtrizeInstance::Process( cv::Mat im) 
{
...
void VtrizeInstance::SendStatus(const std::string& status) 
{
  pp::VarDictionary msg;
  msg.Set( "Type", "status" );
...
void VtrizeInstance::HandleMessage( const pp::Var& var_message ) 
{
